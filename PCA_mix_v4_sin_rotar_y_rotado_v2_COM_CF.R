...
t_modulo<-read_excel("C:/Users/ximen/OneDrive/Escritorio/Pruebas PCA/COMPLETO/CF_COMPLETO_PCA.xlsx")
...
t_modulo$TOTAL_ATRASOS_TARJETA_DEPARTAMENTAL <- as.integer(t_modulo$TOTAL_ATRASOS_TARJETA_DEPARTAMENTAL)
t_modulo$TOTAL_ATRASOS_TARJETA_BANCARIA <- as.integer(t_modulo$TOTAL_ATRASOS_TARJETA_BANCARIA)
t_modulo$TOTAL_ATRASOS__CREDITO_NOMINA <- as.integer(t_modulo$TOTAL_ATRASOS__CREDITO_NOMINA)
t_modulo$TOTAL_ATRASOS_CREDITO_PERSONAL <- as.integer(t_modulo$TOTAL_ATRASOS_CREDITO_PERSONAL)
t_modulo$TOTAL_ATRASOS_CREDITO_AUTOMOTRIZ <- as.integer(t_modulo$TOTAL_ATRASOS_CREDITO_AUTOMOTRIZ)
t_modulo$TOTAL_ATRASOS_CREDITO_VIVIENDA <- as.integer(t_modulo$TOTAL_ATRASOS_CREDITO_VIVIENDA)
t_modulo$TOTAL_ATRASOS_CREDITO_GRUPAL <- as.integer(t_modulo$TOTAL_ATRASOS_CREDITO_GRUPAL)
t_modulo$TOTAL_ATRASOS__CREDITO_X_INTERNET <- as.integer(t_modulo$TOTAL_ATRASOS__CREDITO_X_INTERNET)
t_modulo$TOTAL_ATRASOS_OTRO_CREDITO <- as.integer(t_modulo$TOTAL_ATRASOS_OTRO_CREDITO)
t_modulo$FRECUENCIA_USO_CREDITO_BANCARIO <- as.integer(t_modulo$FRECUENCIA_USO_CREDITO_BANCARIO)
...
n_dim_significativas=15# TAMBIEN SALE BIEN CON 18
