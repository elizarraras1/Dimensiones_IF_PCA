...
t_modulo<-read_excel("C:/Users/ximen/OneDrive/Escritorio/Pruebas PCA/COMPLETO/USO_COMPLETO_PCA.xlsx")
...
t_modulo$TIEMPO_HORAS_SUC_BANC <- as.integer(t_modulo$TIEMPO_HORAS_SUC_BANC)
t_modulo$TIEMPO_MINUTOS_SUC_BANC <- as.integer(t_modulo$TIEMPO_MINUTOS_SUC_BANC)
t_modulo$TIEMPO_HORAS_ATM <- as.integer(t_modulo$TIEMPO_HORAS_ATM)
t_modulo$TIEMPO_MINUTOS_ATM <- as.integer(t_modulo$TIEMPO_MINUTOS_ATM)
t_modulo$TIEMPO_HORAS_CORRESPONSALES <- as.integer(t_modulo$TIEMPO_HORAS_CORRESPONSALES)
t_modulo$TIEMPO_MINUTOS_CORRESPONSALES <- as.integer(t_modulo$TIEMPO_MINUTOS_CORRESPONSALES)
...
n_dim_significativas=13# TAMBIEN SALE BIEN CON 
